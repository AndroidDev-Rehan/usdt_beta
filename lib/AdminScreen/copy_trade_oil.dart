...
class CopyTradeOil extends StatefulWidget {
  CopyTradeOil({Key key}) : super(key: key);

  @override
  _CopyTradeOilState createState() => _CopyTradeOilState();
}

class _CopyTradeOilState extends State<CopyTradeOil> {
  void onEnd() {
    print('back');
    // Get.back();
  }
...
120.obs;
  ...
  void calculateTimer() {
    MyDatabase().getCountDownTime('rCrudeOil').then((value) {
          ...
          children: [
            ...
            GetX<AllUserController>(
                ...
                builder: (AllUserController allUserController) {
                  ...
                  //     allUserController.allUserTOil != null) {
                  return Container(
                            ...
                            children: [
                              ...
                              (allUserController != null &&
                                  ...
                                  ? ListView.builder(
                                      ...
                                      itemCount:
                                          allUserController.allUserTOil.length,
                                        ...
                                        return Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(allUserController
                                                .allUserTOil[index].name),
                                            subtitle: Text(allUserController
                                                .allUserTOil[index].email),
                                            trailing: Column(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(
                                                    'Copy Trade Amount :\$ ${allUserController.allUserTOil[index].tradeAmount.toStringAsFixed(2)}'),
                                                Text(
                                                    'Investment Amount :\$ ${allUserController.allUserTOil[index].investmentAmount.toStringAsFixed(2)}')
                                              ],
                                            ),
                                            onTap: () {},
                                          ),
