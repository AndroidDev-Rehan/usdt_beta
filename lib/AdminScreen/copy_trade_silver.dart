...
class CopyTradeSilver extends StatefulWidget {
  CopyTradeSilver({Key key}) : super(key: key);

  @override
  _CopyTradeSilverState createState() => _CopyTradeSilverState();
}

class _CopyTradeSilverState extends State<CopyTradeSilver> {
  void onEnd() {
    print('back');
    // Get.back();
  }
...
120.obs;
  ...
  void calculateTimer() {
    MyDatabase().getCountDownTime('rSilver').then((value) {
  ...
  startTimer() {
    timer = Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      if (seconds.value == 0 || seconds.value > maxTime) {
        ...
        // MyDatabase().insertCountDown(CountDown(commodityType: 'rSilver'));
          ...
          children: [
            ...
            GetX<AllUserController>(
                ...
                builder: (AllUserController allUserController) {
                  ...
                  //     allUserController.allUserTSilver != null) {
                  return Container(
                                        ...
                                        return Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(allUserController
                                                .allUserTSilver[index].name),
                                            subtitle: Text(allUserController
                                                .allUserTSilver[index].email),
                                            trailing: Column(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(
                                                    'Copy Trade Amount :\$ ${allUserController.allUserTSilver[index].tradeAmount.toStringAsFixed(2)}'),
                                                Text(
                                                    'Investment Amount :\$ ${allUserController.allUserTSilver[index].investmentAmount.toStringAsFixed(2)}')
                                              ],
                                            ),
                                            onTap: () {},
                                          ),
