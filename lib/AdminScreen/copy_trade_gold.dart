...
class CopyTradeGold extends StatefulWidget {
  CopyTradeGold({Key key}) : super(key: key);

  @override
  _CopyTradeGoldState createState() => _CopyTradeGoldState();
}

class _CopyTradeGoldState extends State<CopyTradeGold> {
  void onEnd() {
    print('back');
    // Get.back();
  }
...
120.obs;
  ...
  void calculateTimer() {
    MyDatabase().getCountDownTime('rGold').then((value) {
          ...
          children: [
            ...
            GetX<AllUserController>(
                ...
                builder: (AllUserController allUserController) {
                  ...
                  //     allUserController.allUserTGold != null) {
                  return Container(
                                    ...
                                    confirm: RaisedButton(
                                      onPressed: () {
                                        if (_key.currentState.validate()) {
                                          // allUserController.allUserTGold
                                          //     .forEach((element) {
                                          //   MyDatabase()
                                        ...
                                        return Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(allUserController
                                                .allUserTGold[index].name),
                                            subtitle: Text(allUserController
                                                .allUserTGold[index].email),
                                            trailing: Column(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(
                                                    'Copy Trade Amount :\$ ${allUserController.allUserTGold[index].tradeAmount.toStringAsFixed(2)}'),
                                                Text(
                                                    'Investment Amount :\$ ${allUserController.allUserTGold[index].investmentAmount.toStringAsFixed(2)}')
                                              ],
                                            ),
                                            onTap: () {},
                                          ),
