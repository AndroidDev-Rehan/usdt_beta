...
class CopyTradeCoinbase extends StatefulWidget {
  CopyTradeCoinbase({Key key}) : super(key: key);

  @override
  _CopyTradeCoinbaseState createState() => _CopyTradeCoinbaseState();
}

class _CopyTradeCoinbaseState extends State<CopyTradeCoinbase> {
  void onEnd() {
    print('back');
    // Get.back();
  }
...
420.obs;
  ...
  void calculateTimer() {
    MyDatabase().getCountDownTime('rCoinbase').then((value) {
          ...
          children: [
            ...
            GetX<AllUserController>(
                ...
                builder: (AllUserController allUserController) {
                  ...
                  //     allUserController.allUserTCoinbase != null) {
                  return Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              (allUserController != null &&
                                      allUserController.allUserTCoinbase !=
                                          null)
                                  ? ListView.builder(
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: allUserController
                                          .allUserTCoinbase.length,
                                        ...
                                        return Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(allUserController
                                                .allUserTCoinbase[index].name),
                                            subtitle: Text(allUserController
                                                .allUserTCoinbase[index].email),
                                            trailing: Column(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(
                                                    'Copy Trade Amount :\$ ${allUserController.allUserTCoinbase[index].tradeAmount.toStringAsFixed(2)}'),
                                                Text(
                                                    'Investment Amount :\$ ${allUserController.allUserTCoinbase[index].investmentAmount.toStringAsFixed(2)}')
                                              ],
                                            ),
                                            onTap: () {},
                                          ),
