...
class CopyTradeAmazon extends StatefulWidget {
  CopyTradeAmazon({Key key}) : super(key: key);

  @override
  _CopyTradeAmazonState createState() => _CopyTradeAmazonState();
}

class _CopyTradeAmazonState extends State<CopyTradeAmazon> {
  void onEnd() {
    print('back');
    // Get.back();
  }
  ...
  void calculateTimer() {
    MyDatabase().getCountDownTime('rAmazon').then((value) {
          ...
          children: [
            ...
            GetX<AllUserController>(
                ...
                builder: (AllUserController allUserController) {
                  ...
                  //     allUserController.allUserTAmazon != null) {
                  return Container(
                                    ...
                                    confirm: RaisedButton(
                                      onPressed: () {
                                        if (_key.currentState.validate()) {
                                          // allUserController.allUserTAmazon
                                          //     .forEach((element) {
                                          //   MyDatabase()
                                        ...
                                        return Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(allUserController
                                                .allUserTAmazon[index].name),
                                            subtitle: Text(allUserController
                                                .allUserTAmazon[index].email),
                                            trailing: Column(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(
                                                    'Copy Trade Amount :\$ ${allUserController.allUserTAmazon[index].tradeAmount.toStringAsFixed(2)}'),
                                                Text(
                                                    'Investment Amount :\$ ${allUserController.allUserTAmazon[index].investmentAmount.toStringAsFixed(2)}')
                                              ],
                                            ),
                                            onTap: () {},
                                          ),
